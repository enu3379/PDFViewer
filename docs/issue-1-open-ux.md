...
- 상태: **구현 완료(C1–C8, 2026-07-08 Codex) + 리뷰 후속 R1–R3 반영 완료(2026-07-09, `feature/1-open-ux`).** 남은 것: 실기기 수동 QA(§8)·V1–V4. 결정 이력은 §3.
...
> 실행용 체크리스트는 [issue-1-qa.md](issue-1-qa.md) — OS별로 분리된 단계·기대 결과·준비물 포함. 아래는 설계 시점의 시나리오 원본.
